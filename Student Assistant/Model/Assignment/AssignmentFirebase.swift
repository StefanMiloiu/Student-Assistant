...
struct AssignmentFirebase: Codable {
    ...
    init(assignmentID: UUID? = nil, assignmentEmail: String? = nil, assignmentTitle: String? = nil, assignmentDescription: String? = nil, assignmentGotDate: Date? = nil, assignmentDate: Date? = nil, assignmentStatus: Status, lastUpdated: Date? = nil, lastSynced: Date? = nil, isSynced: Bool? = nil) {
